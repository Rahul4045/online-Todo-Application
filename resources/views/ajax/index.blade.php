...
<body>
    <div class="container">
        ...
        <button id="btnAdd" class="btn btn-outline-info" data-target="#addTodoModal" data-toggle="modal">Add
            Todo:</button>

        <!--Placing the seatch option -->
        <div class="float-right">
            <input type="text" name="search1" id="search1" placeholder="Search title,description..."
                class="form-control">
            <select id="sortField">
